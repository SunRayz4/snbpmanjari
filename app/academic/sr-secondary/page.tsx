          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white p-10 rounded-lg shadow-md ">
              ...
              >
                {/* Centered Image */}
                <Image
                  src="https://www.walkertownacademy.com/wp-content/uploads/2021/07/primary-school-in-secunderabad-Walkertown-Academy-blog.png" // Replace with the path to your image
              ...
              <div className="flex flex-col md:flex-center gap-6 items-start mb-5">
                ...
                >
                  ...
                  >
                    Sr-Secondary Education at Our School
                  </h2>
                  <p className="text-gray-700 mb-4 leading-relaxed">
                    ...
                    confidently embrace the challenges ahead.
                  </p>

                  <p className="text-gray-700 mb-4 leading-relaxed">
                    We focus on cultivating a space that motivates students to
                    come to school each day, excited and ready to learn. Our
                    classrooms are designed to be modern and inspiring, equipped
                    with the latest educational tools to facilitate dynamic
                    learning experiences. These rooms open into dedicated study
                    areas and activity zones, fostering collaboration and
                    exploration.
                  </p>
